...
<template>
  <div class="crepe-container">
    <div class="crepe">
      <img v-if="selectedIngredients.length === 0" src="@/assets/empty-crepe.png" alt="Empty crepe" class="crepe-base"/>
      
      <div v-for="(ingredient, index) in selectedIngredients" :key="index" class="ingredient">
        <img :src="`@/assets/ingredientImages/${ingredient}.png`" :alt="ingredient" />
      </div>
    </div>
