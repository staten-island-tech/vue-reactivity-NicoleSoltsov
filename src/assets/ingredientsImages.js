const ingredientImages = {
  ...
  blackberries: new URL('/src/assets/images/blackberries.avif', import.meta.url).href,
  blueberries: new URL('/src/assets/images/blueberries.jpg', import.meta.url).href,
  caramel: new URL('/src/assets/images/caramel.avif', import.meta.url).href,
